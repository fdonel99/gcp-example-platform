...
def elabora_spese_trasporto(cloud_event):
    ...
    # 3. DEFINIZIONE PERCORSI LOCALI (TRAMITE /tmp/)
    # Aggiornato il nome del bucket per corrispondere esattamente a quello creato in Terraform
    bucket_supporto = "bkt-spese-trasporto"
    ...
    try:
        ...
        # FASE 2: Avvia l'elaborazione usando i percorsi locali
